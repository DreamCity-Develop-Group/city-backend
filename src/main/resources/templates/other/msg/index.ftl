                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="row ">
                            <div class="col-xs-12">
                                ...
                                <button class="btn btn-xs btn-primary" onclick="search();"><i class="fa fa-search"></i>&nbsp;查询
                                </button>
                                <button class="btn btn-xs btn-success " type="button" onclick="add();"><i
    ...
    $(document).ready(function () {
        ...
        $("#helpListTable").bootstrapTable({
            ...
            columns: [{
                ...
                field: "empty",
                formatter: function (value, row, index) {
                    var operateHtml = '<button class="btn btn-danger btn-xs" type="button" onclick="edit(\'' + row.id + '\')"><i class="fa fa-edit"></i>&nbsp;修改</button> &nbsp;';
