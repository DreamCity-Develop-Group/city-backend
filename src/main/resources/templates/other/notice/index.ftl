            ...
            $(document).ready(function () {
                ...
                $("#helpListTable").bootstrapTable({
                    ...
                    columns: [{
                        ...
                        field: "empty",
                        formatter: function (value, row, index) {
                            var operateHtml = '<button class="btn btn-danger btn-primary btn-xs" type="button" onclick="edit(\''+row.noticeId+'\')"><i class="fa fa-edit"></i>&nbsp;修改</button> &nbsp;';
                            ...
                            operateHtml = operateHtml + '<button class="btn label-info btn-xs" type="button" onclick="detail(\''+row.noticeId+'\')"><i class="fa fa-check"></i>&nbsp;详情</button> &nbsp;';
                            return operateHtml;
                        }
                    }]
                });
