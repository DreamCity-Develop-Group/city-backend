								...
								<div class="row ">
                                    <div class="col-xs-12">
										...
										<div class="col-sm-3 form-group">
											买家：<input id="orderPlayerBuyer" name="orderPlayerBuyer" type="text" value="${data.orderPlayerBuyer}"/>
										</div>
										<#--<div class="col-sm-3 form-group">
											卖家：<input id="orderPlayerSeller" name="orderPlayerSeller" type="text" value="${data.orderPlayerSeller}"/>
										</div>
										<div class="col-sm-3 form-group">
											订单购买类型：<input id="orderBuyType" name="orderBuyType" type="text" value="${data.orderBuyType}"/>
										</div>
										<div class="col-sm-3 form-group">
											订单支付类型：<input id="orderPayType" name="orderPayType" type="text" value="${data.orderPayType}"/>
										</div>
										<div class="col-sm-3 form-group">
											订单状态：<input id="orderState" name="orderState" type="text" value="${data.orderState}"/>
										</div>-->
										<#--<div class="col-sm-3 form-group">
            ...
            $(document).ready(function () {
                ...
                $("#helpListTable").bootstrapTable({
					...
					columns: [{
						...
						title: "买家",
						field: "orderPlayerBuyer"
					},{
						title: "卖家",
						field: "orderPlayerSeller"
					},{
						title: "购买额度",
						field: "orderAmount"
					},{
