                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="updateForm">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input id="tradeAmountType" name="tradeAmountType" class="form-control" type="text" value="${data.tradeAmountType}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">金额动态：</label>
                            <div class="col-sm-8">
                                <input id="tradeType" name="tradeType" class="form-control" type="text" value="${data.tradeType}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">交易类型：</label>
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">动账描述：</label>
                            <div class="col-sm-8">
