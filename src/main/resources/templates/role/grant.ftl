...
<head>
    ...
    <link href="${ctx}/backend/css/font-awesome.css" rel="stylesheet">
    <link href="${ctx}/backend/css/animate.css" rel="stylesheet">
    <link href="${ctx}/backend/css/style.css" rel="stylesheet">
    <link href="${ctx}/backend/css/zTree/zTreeStyle/zTreeStyle.css" rel="stylesheet">
...
<body class="gray-bg">
    ...
    <script src="${ctx}/backend/js/zTree/jquery.ztree.all.min.js"></script>
