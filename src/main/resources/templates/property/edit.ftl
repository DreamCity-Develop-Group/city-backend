                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="updateForm">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input id="inType" name="inType" class="form-control" type="text" value="${data.inType}" readonly="readonly">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input id="inPersonalTax" name="inPersonalTax" class="form-control" type="text" value="${data.inPersonalTax}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">企业所得税：</label>
                            <div class="col-sm-8">
                                <input id="inEnterpriseTax" name="inEnterpriseTax" class="form-control" type="text" value="${data.inEnterpriseTax}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">定额税：</label>
                            <div class="col-sm-8">
                                <input id="inQuotaTax" name="inQuotaTax" class="form-control" type="text" value="${data.inQuotaTax}">
                            </div>
                        </div>
                        <div class="form-group">
